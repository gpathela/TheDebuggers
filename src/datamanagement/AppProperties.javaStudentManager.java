...
public class StudentManager {
	 ...
	 */
	private static StudentManager self = null; // Declare and initialize the
												// variable self to null
	private StudentMap sm; // need to change the private variable from sm to
							// studentMap_
	private java.util.HashMap<String, StudentMap> um;

	/**
	 * An instance of the StudentManager class can use the get method to return
	 * itself
	 */
	...
	private Element getStudentElement(Integer id) {
		/**
		 * change XMLManager to XmlManager as abbreviations and acronyms should
		 * not be uppercase
		 */
